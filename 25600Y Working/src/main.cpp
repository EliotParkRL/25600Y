...
void autonomous(void) {
  ...
  turn_till_stop(40,-0.44);
  wait(0.4,sec);


  drive_till_stop(80,10.9);
  wait(3, sec);
  turn_till_stop(50,1.9);
  wait(1.5, sec);
  drive_till_stop(100,8);
  wait(1.5,sec);
  RightWing.set(true);
  turn_till_stop(50,-1.5);
  wait(0.7, sec);
  LeftWing.set(true);
  drive_till_stop(100,5);
  wait(1,sec);
  drive_back_till_stop(100,2.5);
  wait(1,sec);
  drive_till_stop(100,5);
  wait(1,sec);
  drive_back_till_stop(100,2.5);
