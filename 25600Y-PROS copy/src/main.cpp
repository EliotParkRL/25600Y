...
void autonomous() {
	...
	chassis.moveTo(-20, -21, 2000, 100);
	
	chassis.turnTo(-1000, -21, 2000,100);

	chassis.moveTo(-50, -21, 1000);

	chassis.moveTo(-20, -20, 2000, 100);
	
	chassis.turnTo(-2, -100, 2000, 50);
	...
	chassis.moveTo(0,0,5000,100);
	chassis.turnTo(0,10000,1000, 40);
	chassis.moveTo(0,80,3000,150);
	chassis.moveTo(-20,105,2000,150);
	chassis.turnTo(-100000, 105, 1000, 40);
	chassis.moveTo(-50, 95, 2000);
