...
void autonomous() {
	intake.move(127);
	RightWingFront.set_value(true);
	pros::delay(200);
	intake.move(0);
	RightWingFront.set_value(false);

	chassis.turnTo(0,1000, 1000, 60);

	LeftWingBack.set_value(true);

	chassis.moveTo(-5,21,1000, 100);

	LeftWingBack.set_value(false);
	chassis.turnTo(-1000,22, 1000, 60);

	chassis.moveTo(-30, 26, 1000, 100);

	chassis.moveTo(-5, 22, 1000, 100);

	chassis.moveTo(-30, 28, 1000, 100);

	chassis.setPose(0,0,90);

	chassis.moveTo(13,0,1000,100);
	
	chassis.turnTo(30,48,2000, 60);

	intake.move(-127);

	chassis.moveTo(-4,-68,1000, 80);
	// chassis.turnTo(-10,-60,1000,60);
	pros::delay(500);

	chassis.moveTo(-22,-65, 1000, 80);

	chassis.turnTo(-28,-1000,1000, 60);

	LeftWingFront.set_value(true);
	RightWingFront.set_value(true);
	intake.move(127);

	chassis.moveTo(-22,10,1000,150);

	LeftWingFront.set_value(false);
	RightWingFront.set_value(false);


	chassis.moveTo(-10,-40,1000,100);
